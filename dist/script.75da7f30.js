...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../data/data.json":[function(require,module,exports) {
module.exports = {
  "cards": [{
    "name": "Карточка №1",
    "text": "Текст карточки",
...
function add_card() {
  ...
  id_counter++;
  container.innerHTML = container.innerHTML + '<div class = \"col-sm\">\n<div class=\"card\" style=\"width: 200px;\">\n<div class=\"card-body\">\n<h5 class=\"card-title\">' + name + '</h5>\n<p class=\"card-text\">' + text + '</p>\n<button type=\"button\" class=\"btn btn-primary\" id = \"' + id_counter + '\"  data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\" style = \"background-color: #29b6f6;\">Изменить</button>\n</div>\n</div>\n</div>\n';
  document.getElementById("create_name").value = "";
  document.getElementById("create_text").value = "";
  update_event();
}
function change_card() {
  var name = document.getElementById("create_name").value;
  var text = document.getElementById("create_text").value;
  change_buttons[last_clicked - 1].parentNode.childNodes[1].textContent = name;
  change_buttons[last_clicked - 1].parentNode.childNodes[3].textContent = text;
}
var save = document.getElementById("save");
save.addEventListener('click', function () {
  var name = document.getElementById("create_name").value;
  var text = document.getElementById("create_text").value;
  if (isNaN(parseInt(name[0])) && name != "" && text != "") {
    if (modal.childNodes[1].childNodes[1].childNodes[1].childNodes[1].textContent == "Создать карточку") {
      add_card();
    } else {
      change_card();
    }
  } else if (!isNaN(parseInt(name[0]))) alert("Название карточки не может начинаться с цифры!");else if (name == "" || text == "") alert("Все поля должны быть заполнены!");
});
},{"jquery":"../node_modules/jquery/dist/jquery.js","../data/data.json":"../data/data.json"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
